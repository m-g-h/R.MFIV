...
We select an exemplary entry as an example. This observation will be our "near-term" contract. Also note that `option_quotes` is a "nested" data.table itself
```{r}
...
```
Optionally calculate the Implied Variance &sigma;^2^
```{r}
